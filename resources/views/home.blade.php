...
@section('body')
    ...
    <div class="relative h-3/4">
        ...
        <div class="z-[2] absolute top-0 left-0 bottom-0 right-0 flex flex-col justify-center items-center bg-black/10 text-white p-6">
            ...
            <form method="GET" action="" class="flex flex-col lg:flex-row gap-5 mt-5">
        ...
        <section class="">
            ...
            <div class="grid lg:grid-cols-4 gap-3">
                @foreach($travels as $travel)
                    <a href="{{ route('travels.show', $travel) }}" class="card group overflow-hidden {{ $loop->first || $loop->last ? 'lg:col-span-2' : '' }}">
